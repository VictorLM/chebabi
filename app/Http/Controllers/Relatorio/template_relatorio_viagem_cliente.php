...
$totalcliente = $request->input('totalkm')*0.8 + $request->input('totalgastos');
...
<html>
    <body>
        <div id="principal">
            ...
            <br>
            <h3>TRAJETO</h3>
            <table id="clientes3" border="1">
                <tr>
                    <th><b><i>ENDEREÇO A</i></b></td>
                    <th><b><i>ENDEREÇO B</i></b></td>
                    <th><b><i>ENDEREÇO C</i></b></td>
                    <th><b><i>ENDEREÇO D</i></b></td>
                </tr>
                <tr>
                    <td>'.$request->input('enda').'</td>
                    <td>'.$request->input('endb').'</td>
                    <td>'.$request->input('endc').'</td>
                    <td>'.$request->input('endd').'</td>
                </tr>
            </table>
            <br>
            ...
            <table id="clientes2" border="1">
                ...
                <tr>
                    <td>Km</td>
                    <td>R$ '.$request->input('totalkm')*0.8.'</td>
                </tr>
                <tr>
