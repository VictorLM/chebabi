    ...
    <html>
        <body>
            <div id="principal">
                ...
                <table  id="clientes2" border="1">
                    <tr>
                        <td><b>Endereço A:</b> ' .$request->input('enda'). '</td>
                        <td><b>Endereço B:</b> ' .$request->input('endb'). '</td>
                    </tr>
                    <tr>
                        <td><b>Endereço C:</b> ' .$request->input('endc'). '</td>
                        <td><b>Endereço D:</b> ' .$request->input('endd'). '</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td><b>Total KM:</b> ' .$request->input('totalkm'). '</td>
                        <td><b>Pedágio:</b> ' .$pedagio. '</td>
                    </tr>
                </table>
                <br>
                ...
                <table  id="clientes2" border="1">
                    <tr>
                        <td><b>Valor caução:</b> R$ ' .$request->input('caucao'). '</td>
                        <td><b>Valor KM (R$ 0,80/Km):</b> R$ ' .$request->input('valorkm'). '</td>
                    </tr>
                    <tr>
        ...
        <body>
            <div id="principal">
                ...
                <table  id="clientes2" border="1">
                    ...
                    <tr>
                        <td><b>Descrição viagem:</b> ' .$request->input('motivoviagem1'). '</td>
                        <td><b>Data da viagem:</b> ' . Carbon\Carbon::parse($request->input('data'))->format('d/m/Y'). '</td>
                    </tr>
                    <tr>
                        <td><b>Total KM:</b> ' .$request->input('totalkm'). '</td>
