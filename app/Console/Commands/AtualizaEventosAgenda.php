                ...
                foreach ($result['value'] as $key => $value) {
                    ...
                    Eventos::updateOrCreate(
                        ...
                        [
                            ...
                            'title' => $value['subject'],
                            'tipo' => $tipo,
                            'start' => Carbon::parse($value['start']['dateTime'])->subHours(3)->format('Y-m-d H:i:s'),
                            'end' => Carbon::parse($value['end']['dateTime'])->subHours(3)->format('Y-m-d H:i:s'),
                            'descricao' => $value['body']['content'],
                            'created_at' => Carbon::parse($value['createdDateTime'])->subHours(3)->format('Y-m-d H:i:s'),
                            'updated_at' => Carbon::parse($value['lastModifiedDateTime'])->subHours(3)->format('Y-m-d H:i:s'),
