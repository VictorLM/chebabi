...
class CreateTerapiasMassagensRelaxantesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('terapias_massagens_relaxantes', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->boolean('confirmado')->nullable()->default(0);
    ...
    {
        Schema::dropIfExists('terapias_massagens_relaxantes');
    }
}
