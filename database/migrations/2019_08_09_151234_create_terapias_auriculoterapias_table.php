...
class CreateTerapiasAuriculoterapiasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('terapias_auriculoterapias', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('terapias_auriculoterapias');
    }
}
