terapias_quick_massages<?php

use Illuminate\Support\Facades\Schema;
use Illuminate\Database\Schema\Blueprint;
use Illuminate\Database\Migrations\Migration;

class CreateTerapiasQuickMassagesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('terapias_quick_massages', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('terapias_quick_massages');
    }
}
