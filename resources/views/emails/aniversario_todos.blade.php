...
<div style="color:#555555;line-height:120%;font-family:'Roboto', Tahoma, Verdana, Segoe, sans-serif; padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px;">	
  <div style="font-size:12px;line-height:14px;font-family:Roboto, Tahoma, Verdana, Segoe, sans-serif;color:#555555;text-align:left;">
    ...
    <p style="margin: 0;font-size: 14px;line-height: 17px;text-align: center">
      ...
      <span style="font-size: 42px; line-height: 50px;">Hoje é aniversário de: </span></p><br/>

      @foreach($content as $user)
        <span style="font-size: 30px; line-height: 50px;"><b>{{$user->name}}</b></span><br/><br/>
      @endforeach
            ...
            <!--[if (!mso)&(!IE)]><!--><div style="border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent; padding-top:5px; padding-bottom:5px; padding-right: 0px; padding-left: 0px;"><!--<![endif]-->
                  ...
                  <div class="">
                    ...
                    <div style="font-size:12px;line-height:14px;color:#555555;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;text-align:left;">
                      ...
                      <p style="margin: 0;font-size: 24px;line-height: 29px">
                        <span style="font-size: 24px; line-height: 28px;">
                          Envie uma mensagem de aniversário clicando <a style="color:#0068A5;text-decoration: underline;" href="http://www.chebabi.com/intranet/aniversariantes" target="_blank" rel="noopener">aqui</a> !
                        </span>
                      </p>
