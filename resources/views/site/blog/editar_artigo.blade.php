...
<div class="container"> 
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h2><a href="{{url('/intranet/admin/blog-editar-artigo')}}"><i class="glyphicon glyphicon-arrow-left"></i></a> Blog - Editar Artigo</h2>
        ...
        <div class="panel-body">
            ...
            <form id="form" method="POST" enctype="multipart/form-data" action="{{action('Blog\BlogController@update_artigo')}}">
                {{ csrf_field() }}
                ...
                <div class="row">
                    ...
                    <div class="form-group col-xs-12 col-sm-12 col-md-6 col-lg-6{{ $errors->has('titulo') ? ' has-error' : '' }}">
                        <label>* Título</label>
                        <input type="text" class="form-control" name="titulo" maxlength="200" value="{{old('titulo', $artigo->titulo)}}" required>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-xs-12 col-sm-12 col-md-6 col-lg-6{{ $errors->has('categoria') ? ' has-error' : '' }}">
                        ...
                        <select class="form-control" name="categoria" required>
                            ...
                            @else
                                <option value="Cível" @if($artigo->categoria=='Cível') selected @endif>Cível</option>
                                <option value="Trabalhista" @if($artigo->categoria =='Trabalhista') selected @endif>Trabalhista</option>
                                <option value="Outros" @if($artigo->categoria =='Outros') selected @endif>Outros</option>
                            @endif
                ...
                <div class="row">
                    ...
                    <div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12{{ $errors->has('tags') ? ' has-error' : '' }}">
                        <label>* Tags</label>
                        <input type="text" class="form-control" name="tags" maxlength="200" value="{{old('tags', $artigo->tags)}}" placeholder="Separe as tags com vírgulas" required>
                        @if ($errors->has('tags'))
                            <span class="help-block">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12{{ $errors->has('descricao') ? ' has-error' : '' }}">
                        ...
                        @endif
                        <input name="descricao" id="descricao" type="hidden" value="{{old('descricao', $artigo->descricao)}}">
                    </div>
