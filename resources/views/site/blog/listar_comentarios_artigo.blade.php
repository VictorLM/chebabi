...
<div class="container">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-heading">
                <h2><a href="{{url('/intranet/admin/blog-editar-artigo')}}"><i class="glyphicon glyphicon-arrow-left"></i></a> Blog - Comentários do Artigo</h2>
            </div>
                        ...
                        @if(count($comentarios)>0)
                            @foreach($comentarios as $comentario)
                                <tr>
                                    ...
                                    <td>
                                        <form method="POST" action="{{action('Blog\BlogController@excluir_comentario_artigo')}}">
                                            {{ csrf_field() }}
