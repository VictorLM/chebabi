...
<div class="container"> 
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h2><a href="{{url('/intranet/admin')}}"><i class="glyphicon glyphicon-arrow-left"></i></a> Blog - Editar História</h2>
        ...
        <div class="panel-body">
            ...
            <form id="form" method="POST" enctype="multipart/form-data" action="{{action('Blog\BlogController@update_historia')}}">
                {{ csrf_field() }}
                ...
                <div class="row">
                    ...
                    <div class="form-group col-xs-12 col-sm-12 col-md-6 col-lg-6{{ $errors->has('titulo') ? ' has-error' : '' }}">
                        <label>* Título</label>
                        <input type="text" class="form-control" name="titulo" maxlength="200" value="{{old('titulo', $historia->titulo)}}" required>
                    ...
                    <div class="form-group col-xs-12 col-sm-12 col-md-6 col-lg-6{{ $errors->has('link') ? ' has-error' : '' }}">
                        ...
                        <input type="text" class="form-control" name="link" maxlength="100" value="{{old('titulo', $historia->link)}}" placeholder="https://www.youtube.com/embed/a1b2c3d4e5" required>
                        @if ($errors->has('link'))
                            <span class="help-block">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12{{ $errors->has('tags') ? ' has-error' : '' }}">
                        <label>* Tags</label>
                        <input type="text" class="form-control" name="tags" maxlength="200" value="{{old('titulo', $historia->tags)}}" placeholder="Separe as tags com vírgulas" required>
                        @if ($errors->has('tags'))
                            <span class="help-block">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12{{ $errors->has('descricao') ? ' has-error' : '' }}">
                        ...
                        @endif
                        <input name="descricao" id="descricao" type="hidden" value="{{old('descricao', $historia->descricao)}}">
                    </div>
