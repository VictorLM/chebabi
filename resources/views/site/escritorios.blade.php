...
@section('conteudo')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-light breadcrumb-custom">
            ...
            <li class="breadcrumb-item active" aria-current="page">Escritórios</li>
        </ol>
    </nav>
    ...
    <div class="card bg-light mb-3">
        <div class="card-body">
            ...
            <h1 class="text-center">ESCRITÓRIOS</h1>
            <hr/>
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p>
                                Localização privilegiada, próxima a vários Órgãos Jurídicos, como a Sede Administrativa do
                                Tribunal do Trabalho, o próprio <a href="http://portal.trt15.jus.br/trt15" target="_blank">
                                Tribunal Regional do Trabalho da 15ª Região</a>, a 5ª Subseção Judiciária do Juizado Especial 
                                Federal Cível de Campinas, entre outros.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p>Localização de fácil acesso, a poucos metros do Fórum Trabalhista Ruy Barbosa.</p>
                        </div>
                    </div>
                </div>
