...
<html>
    ...
    <!-- Slider -->
    <div class="slider">
        <img alt="advogados" title="advogados" class="mySlides w3-animate-fading" src="{{url('assets/imagens/slides/banner-1.jpg')}}">
        <img alt="advogados" title="advogados" class="mySlides w3-animate-fading" src="{{url('assets/imagens/slides/banner-2.jpg')}}">
        <img alt="advogados" title="advogados" class="mySlides w3-animate-fading" src="{{url('assets/imagens/slides/banner-3.jpg')}}">
    </div>
    <!-- JS Slider -->
