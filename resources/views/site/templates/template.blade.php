...
<html lang="pt-BR">
    ...
    <body>
                ...
                <div class="collapse navbar-collapse" id="navbarNavDropdown">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                <a class="dropdown-item" href="{{url('/blog')}}">ARTIGOS</a>
                                <a class="dropdown-item" href="{{url('/blog/historias')}}">HISTÓRIAS</a>
        ...
        <footer class="footer bg-light text-center">
            ...
            <p>© Copyright © {{Carbon\Carbon::now()->year}} - Izique Chebabi Advogados Associados. Todos os direitos reservados.</p>
        </footer>
