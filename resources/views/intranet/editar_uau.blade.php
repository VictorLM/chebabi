...
<div class="container">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-heading">
                <h2>
                    <a href="{{url('/intranet/uau')}}"><i class="glyphicon glyphicon-arrow-left"></i></a> Editar Uau
                </h2>
            </div>
            ...
            <div class="panel-body inline">
                ...
                <form method="POST" id="form" action="{{action('Intranet\IntranetController@editar_uau', $uau->id)}}">
                    {!! csrf_field() !!}
                    <div style="margin:1em;">
                        <span>Eu, <b>{{Auth::user()->name}},</b> atesto que &nbsp;</span>
                        <select class="novo-uau-input" style="width:auto;height:auto;" name="para" id="para" required @if($errors->has('para')) style="border-color:red;"@endif>
                            <option value="{{$uau->para_nome->id}}" selected>{{$uau->para_nome->name}}</option>
                        </select>
                        ...
                        <br/>
                        <button type="submit" class="btn btn-primary btn-lg" style="float:right;"><i class="glyphicon glyphicon-send"></i> Editar</button>
                    </div>
