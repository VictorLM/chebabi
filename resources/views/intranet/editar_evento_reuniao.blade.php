    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading">
            <h2>
                ...
                Editar Evento Reunião: {{$evento->title}} / Criador: {{$evento->organizador_nome}}
            </h2>
        </div>
        ...
        <div class="panel-body">
            ...
            <form method="POST" id="form" action="{{action('APIs\MicrosoftController@update_evento')}}">
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="text" class="form-control" name="titulo" maxlength="200" value="{{old('titulo', $titulo)}}" required @if($errors->has('titulo')) style="border-color:red;" autofocus @endif>
                ...
                <div class="form-group col-md-4">
                    ...
                    <select class="form-control" id="local" name="local" required>
                        @if($evento->local != "Sala 1" && $evento->local != "Sala 2")
                            <option value="{{old('local', $evento->local)}}">{{old('local', $evento->local)}}</option>
                        ...
                        @else
                            <option value="Sala 1" @if(old('local', $evento->local)=='Sala 1') selected @endif>Sala 1</option>
                            <option value="Sala 2" @if(old('local', $evento->local)=='Sala 2') selected @endif>Sala 2</option>
                            <option value="Outro">Outro</option>
                        @endif
                    </select>
                ...
                <div class="form-group col-md-2">
                    ...
                    <input type="date" class="form-control" name="iniciodata" id="iniciodata" value="{{old('iniciodata', Carbon\Carbon::parse($evento->start)->format('Y-m-d'))}}" required @if($errors->has('iniciodata')) style="border-color:red;" autofocus @endif>
                ...
                <div class="form-group col-md-2">
                    ...
                    <input type="time" class="form-control" name="iniciohora" id="iniciohora" value="{{old('iniciohora', Carbon\Carbon::parse($evento->start)->format('H:i'))}}" required @if($errors->has('iniciohora')) style="border-color:red;" autofocus @endif>
                ...
                <div class="form-group col-md-2">
                    ...
                    <input type="date" class="form-control" name="terminodata" id="terminodata" value="{{old('terminodata', Carbon\Carbon::parse($evento->end)->format('Y-m-d'))}}" required @if($errors->has('terminodata')) style="border-color:red;" autofocus @endif>
                ...
                <div class="form-group col-md-2">
                    ...
                    <input type="time" class="form-control" name="terminohora" id="terminohora" value="{{old('terminohora', Carbon\Carbon::parse($evento->end)->format('H:i'))}}" required @if($errors->has('terminohora')) style="border-color:red;" autofocus @endif>
                ...
                <div class="form-group col-md-12">
                    ...
                    @if($errors->has('descricao')) style="border-color:red;" autofocus @endif>{{old('descricao', strip_tags($evento->descricao))}}</textarea>
